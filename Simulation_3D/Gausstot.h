...
class GaussSeidel {
    public:
      ...
      void set_data_output(double *displ_out,double *angleact_out,double *FtotZMPOut,double *Fc_mc3_out,double *PSurf3,double *ind_cont_out,double *ind_slip_out,double *Kcart_out);
    ...
    private:
		...
		Vector3d displ;
        Vector3d displ_ini;
        Vector3d displ_first;
        Vector3d angleact;
        Vector3d angleact_ini;
		MatrixXd displ_m;
