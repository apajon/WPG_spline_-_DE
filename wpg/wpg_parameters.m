...
%             obj.poly_degree=6;
        ...
        function obj=robot_config(obj,robot)
            ...
            switch(obj.robot)
                ...
                case 2
                    ...
                    obj.xankmax = 0.4; %stepping forward max
                    obj.xankmin = -0.4; %stepping forward min (if negative, it means stepping backward max)
                    obj.yankmin = obj.inttoankle+0.04; %width min between ankles
                    obj.yankmax = obj.inttoankle+0.4; %width max between ankles	
					%%% define initial - final positions of right and left foot%%%
                    ...
                    switch (obj.type_traj)
                        ...
                        case 2
                            obj.pankfin_lastSS = [1.0095 (obj.rightorleft)^obj.nbstep*0.0815817];
                            obj.pankfin_lastinair = [1.0095 -(obj.rightorleft)^obj.nbstep*0.0815817];
                        case 3
        ...
        function obj=time_config(obj)
            ...
            obj.tss = 0.90; %time duration of single support phases in ms %WARNING:  * frequency / nbpolyssp = positive integer
